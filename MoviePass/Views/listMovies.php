<?php 
    ...
    */
    $list_peliculas = file_get_contents(
        'https://api.themoviedb.org/3/movie/now_playing?api_key=<<your_key>>&language=es-ES&page=1'
    );
    ...
    */
    foreach($decode['results'] as $allresults){
        ...
        array_push($arregloPeliculas, $movie);
    }
    echo '<h1>Arreglo de peliculas</h1>';
    print_r($arregloPeliculas);
?>
